...
function Header() {
  ...
  return (
    <header className="sticky bg-[#C3DADB]  w-full top-0 left-0 shadow-md z-50">
      ...
      {/* Mobile Menu */}
      {isOpen && (
        <ul className="md:hidden bg-[#C3DADB] absolute top-16 left-0 w-full flex flex-col items-center space-y-4 py-6 shadow-lg">
          {["home", "about", "projects", "contact"].map((section) => (
            <li key={section}>
              <Link
                to={section}
